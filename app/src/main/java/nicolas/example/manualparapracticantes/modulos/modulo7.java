...
public class modulo7 extends AppCompatActivity {
    //variables y arrays
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Preguntas = getResources().getStringArray(R.array.todas_preguntas7);//LLenar array de preguntas
        ...
        btn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (index == correcto) { //como ya definimos cual opcion tiene el * lo que hacemos es comprobar si la posicion de la opcion seleccionada
                    ...
                    mp = MediaPlayer.create(modulo7.this, R.raw.check);
                    mp.start();
                    Corazones ++;
                    cora.setText("" + Corazones);
                }else {
                    mp = MediaPlayer.create(modulo7.this, R.raw.error);
                    mp.start();
                }
        ...
        builder.setMessage(R.string.salir_quiz)
                .setPositiveButton(R.string.si, new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        Intent intent = new Intent(modulo7.this, MainActivity.class);
