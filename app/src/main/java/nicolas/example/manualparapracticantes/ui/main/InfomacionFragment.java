...
import nicolas.example.manualparapracticantes.extras.Persona;
import nicolas.example.manualparapracticantes.extras.Registro;

public class InfomacionFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
       ...
       /* Toast.makeText(getContext(), mipass, Toast.LENGTH_SHORT).show();
        ...
        corr = v.findViewById(R.id.userEmail);
        nomb = v.findViewById(R.id.userNombre);

        reg = v.findViewById(R.id.btnRegistro);
        cerrar = v.findViewById(R.id.btnCerrar);
        incio_S = v.findViewById(R.id.btnIniciar);
        puntos = v.findViewById(R.id.puntosQuiz);
        imagenUser = v.findViewById(R.id.userImagen);
         //Intancias firebase
                     ...
                     mGoogleSignInClient.signOut().addOnCompleteListener(new OnCompleteListener<Void>() {
                         ...
                         public void onComplete(@NonNull Task<Void> task) {
                             ...
                             if(task.isSuccessful()){
                                 ...
                                 Toast.makeText(getActivity(), "No se pudo cerrar sesión con google",
        ...
        reg.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Activity estaACtivity = getActivity();
                ((Comunicacion)estaACtivity).registro();
        ...
        incio_S.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Activity estaACtivity = getActivity();
                ((Comunicacion)estaACtivity).iniciar();
